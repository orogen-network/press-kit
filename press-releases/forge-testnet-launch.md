...
The network token is OROG, with a 75/15/5/5 emission split (operators, validators, treasury, ecosystem) and a 12% investor allocation behind a 4-year cliff plus 4-year linear vest. Governance moves on-chain after mainnet TGE; foundation control of the mint is contractually capped, not policy-capped. The testnet is Forge; it is live today. Mainnet TGE follows multi-firm audit completion.
...
This release describes the live Forge testnet as of the date above. Mainnet TGE follows multi-firm audit completion. Nothing in this release constitutes investment advice, a solicitation, or an offer of securities. Jurisdictional eligibility is determined at mainnet TGE.
